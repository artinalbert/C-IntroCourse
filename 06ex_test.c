...
static TestCase test_cases2[TEST_CASES_2] = {
    {.len = 81, .arr = NULL, .count = 41, .name = "sort_it1", .file_in = "sort_it1.png"},
    {.len = 27, .arr = NULL, .count = 14, .name = "sort_it2", .file_in = "sort_it2.png"},
    {.len = 9, .arr = NULL, .count = 5, .name = "sort_it3", .file_in = "sort_it3.png"},
    {.len = 3, .arr = NULL, .count = 2, .name = "sort_it4", .file_in = "sort_it4.png"},
...
int main(int argc, char const *argv[]) {
    ...
    test_cases2[0].arr = (uint8_t *) malloc(81);
    for (int i = 0; i < 81; i++) {
        test_cases2[0].arr[i] = randu64() % 256;
    }

    test_cases2[1].arr = (uint8_t *) malloc(27);
    for (int i = 0; i < 27; i++) {
    ...
    test_cases2[3].arr = (uint8_t *) malloc(3);
    for (int i = 0; i < 3; i++) {
    ...
    // /* Aufgabe 2*/
    if (begin_exercise(&tester, "sort_it", "Aufgabe 2: Den Sortieralgorithmus rekonstruieren."))
    {
